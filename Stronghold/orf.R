require(seqinr) # fasta file handling
seq = read.fasta("rosalind_orf.txt",seqonly = T)[[1]]
...
(res = unique(matches[complete.cases(matches)])) # consolidate result to one variable
